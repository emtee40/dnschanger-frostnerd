...
public class SettingsFragment extends PreferenceFragmentCompat implements SearchablePreference, SearchView.OnQueryTextListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(API.isTaskerInstalled(getContext()))findPreference("warn_automation_tasker").setSummary(R.string.summary_automation_warn);
        ...
        if(!Preferences.getBoolean(getContext(), "debug",false))debugCategory.removePreference(sendDebugPreference);
        ...
        v4Enabled.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, final Object newValue) {
                ...
                Preferences.put(getContext(),preference.getKey(),newValue);
                if(!val)new AlertDialog.Builder(getContext(), ThemeHandler.getDialogTheme(getContext())).setNegativeButton(R.string.cancel, null).
                        setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                v6Enabled.setEnabled(val);
                                if(API.isServiceRunning(getContext()))getContext().startService(new Intent(getContext(), DNSVpnService.class).putExtra(VPNServiceArgument.COMMAND_START_VPN.getArgument(), true));
