...
public class TilePause extends android.service.quicksettings.TileService {
    private static final String LOG_TAG = "[PauseTile]";
    ...
    public void onStartListening() {
        ...
        if(API.isServiceRunning(this)){
            ...
            LogFactory.writeMessage(this, LOG_TAG, "Service running (State set to unavailable)");
    ...
    public void onClick() {
        ...
        if(pinProtected){
            ...
            LogFactory.writeMessage(this, LOG_TAG, "Tile is Pin protected. Pausing DNSVPNService",
                    i = DNSVpnService.getStopVPNIntent(this));
            startService(i);
        }
    }
